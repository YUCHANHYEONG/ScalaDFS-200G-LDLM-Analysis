...
Provides:	kmod-lustre-osd-zfs = %{version}
Provides:	lustre-osd-zfs-mount = %{version}
%endif
%if %{with ldiskfs}
Provides:	lustre-osd-ldiskfs = %{version}
Provides:	kmod-lustre-osd-ldiskfs = %{version}
Provides:	lustre-osd-ldiskfs-mount = %{version}
%endif
Provides:	lustre-osd
%else
