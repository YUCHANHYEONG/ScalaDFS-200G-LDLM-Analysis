...
extern const struct ptlrpc_bulk_frag_ops ptlrpc_bulk_kiov_multiple_md_ops;
...
int ptlrpc_set_wait_mdt(const struct lu_env *env, struct ptlrpc_request_set *);
...
void application_add_req(struct ptlrpc_request *req, struct ptlrpc_request_set *set);
