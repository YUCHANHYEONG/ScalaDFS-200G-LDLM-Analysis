...
#define saved_context_gdt_desc 274 /* offsetof(struct saved_context, gdt_desc) */


#define stack_canary_offset 40 /* offsetof(struct fixed_percpu_data, stack_canary) */

#define __NR_syscall_max 439 /* sizeof(syscalls_64) - 1 */
#define NR_syscalls 440 /* sizeof(syscalls_64) */
#define __NR_syscall_compat_max 439 /* sizeof(syscalls_ia32) - 1 */
#define IA32_NR_syscalls 440 /* sizeof(syscalls_ia32) */
...
#define VMX_spec_ctrl 8720 /* offsetof(struct vcpu_vmx, spec_ctrl) */
