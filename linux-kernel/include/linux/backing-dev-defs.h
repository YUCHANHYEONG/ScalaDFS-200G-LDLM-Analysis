...
#include <linux/lockfree_queue.h>
...
struct bdi_writeback {
	...
	struct slist_head lustre_dirty;	/* Lustre dirty inodes */
	struct list_head test_list;
	/* ych	*/
	struct ListRL lock_free_dirty;	/* lock-free dirty inodes */
	//struct QueueLF	lock_free_dirty;	/* lock-free dirty inodes */
	/* ych	*/
	...
	struct percpu_ref running_refcnt; /* refcnt for running writeback */
	// struct percpu_ref dirty_refcnt; /* refcnt for dirty writeback */
};
